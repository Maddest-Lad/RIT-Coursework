...
public class MovieMain {
    ...
    public void mainLoop() {
        ...
        while (in.hasNext()) {
            ...
            {
                case CONTAINS:
                    processContains(fields);
                    break;
                case LOOKUP:
                    processLookup(fields[1]);
                    break;
                case YEAR_AND_GENRE:
                    processYearAndGenre(fields[1], Integer.parseInt(fields[2]), fields[3]);
                    break;
                case RUNTIME:
                    processRuntime(fields[1], Integer.parseInt(fields[2]), Integer.parseInt(fields[3]));
                    break;
                case MOST_VOTES:
                    processMostVotes(Integer.parseInt(fields[1]), fields[2]);
                    break;
                case TOP:
                    processTop(Integer.parseInt(fields[1]), fields[2],
