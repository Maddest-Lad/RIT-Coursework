...
public final class Movie implements Comparable<Movie> {
    ...
    public boolean equals(Object other) {
        ...
        {
            return title.equals(((Movie) other).title) && year == ((Movie) other).year;
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(title, year);     // remove when correctly implemented
    }
    ...
    public int compareTo(Movie other) {
        // Not sure if this is the RIT way, but it seems like the most readable way
