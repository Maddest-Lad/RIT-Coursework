...
public class GroceryLine {
    ...
    public static void main(String[] args) {
        ...
        try
        {
             ...
             */
            CustomerPool customerPool = new CustomerPool(checkoutLine, Integer.parseInt(args[0]), Integer.parseInt(args[1]), Double.parseDouble(args[2]));
            Thread clerkThread = new Thread(new Clerk(checkoutLine));
            ...
            List<Cart> carts = customerPool.simulateCustomers(); // This Feels Weird
            clerkThread.start();
            ...
            String format = "Average %10s time was %8.1f msec." + System.lineSeparator();
