...
public class TestQueues {
    ...
    private static void fifo() {
        System.out.println(System.lineSeparator() + "FIFO" + System.lineSeparator());
        go(new FIFOTSQueue<>());
    }
    ...
    private static void prio() {
        System.out.println(System.lineSeparator() + "Priority" + System.lineSeparator());
    ...
    private static void put(TSQueue<TimedInteger> q, int item) {
        synchronized (LOCK)
        {
            System.out.println("Producer " + Thread.currentThread().getId() + " is putting " + item + '.');
